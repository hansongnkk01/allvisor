...
export function HomeDemoPage({ view, niche, orgName, entityTitle, scheduleLabel }: Props) {
  const content = (() => {
    ...
    // Salon niche — exact real-page layouts
    if (view === "commissions") return <SalonCommissionsDemo />;

    // Pharmacy niche — exact real-page layouts
    if (view === "batches") return <PharmacyBatchesDemo />;

    // Physio niche — exact real-page layouts
    if (view === "packages") return <PhysioPackagesDemo />;

    // Lab niche — exact real-page layouts
    if (view === "labResults") return <LabResultsDemo />;
    ...
    // Contractor niche — exact real-page layouts
    if (view === "projects") return <ContractorProjectsDemo />;
