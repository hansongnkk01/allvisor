  ...
  const rows = useMemo(
    () => [
      ...
      },
      {
        ...
        class_id: "cl2",
        customer_id: "c2",
        attended_on: new Date(new Date().getTime() - 86400000).toISOString().slice(0, 10),
        present: true,
    ...
    () => [
      {
        ...
        due_at: new Date(new Date().getTime() + 3 * 86400000).toISOString(),
        max_score: 100,
        subject_id: "s1",
      },
      {
        ...
        due_at: new Date(new Date().getTime() + 7 * 86400000).toISOString(),
        max_score: 50,
        subject_id: "s2",
      },
    ],
