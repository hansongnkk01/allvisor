    ...
    navSections: [
      {
        id: "operations",
        labelKey: "operationsZone",
        keys: ["dashboard", "customers", "appointments", "packages", "pos", "invoices"],
      },
      {
        id: "settings",
        labelKey: "settingsZone",
    ...
    navSections: [
      {
        id: "operations",
        labelKey: "operationsZone",
        // Invoice-first desk: billing before POS chrome
        keys: ["dashboard", "customers", "invoices", "pos", "cash"],
      },
      {
        id: "settings",
        labelKey: "settingsZone",
...
export const NAV_HREF: Record<string, string> = {
  ...
  batches: "/batches",
  rxAttach: "/rx-attach",
  controlledRegister: "/controlled-register",
  eyeRx: "/eye-rx",
