-- Roles, titles, patient attribution, invoice extras, branch linking
...
-- Soft-deleted patient audit (kept for visibility of who deleted)
...
-- Branch linking between Allvisor organizations
...
-- Allow supervisor to manage memberships (alongside owner/admin)
